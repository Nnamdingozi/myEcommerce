...
checkoutRouter.post('/initialize/:orderId', authenticate as RequestHandler, CreateCheckoutHandler as RequestHandler);
...
checkoutRouter.get('/verify', authenticate as RequestHandler, verifyCheckoutHandler as RequestHandler);
