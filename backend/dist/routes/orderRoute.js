...
//  *                   type: string
//  */
// orderRoute.get('/:orderId', authenticate, getOrderByIdHandler);
 ...
 *         description: Order created successfully
 */
orderRoute.post('/', authMiddleware_1.authenticate, orderController_1.createOrderHandler);
/**
 * @swagger
 * /orders:
 *   get:
 ...
 *         description: List of orders retrieved successfully
 */
orderRoute.get('/', authMiddleware_1.authenticate, orderController_1.getAllOrderHandler);
/**
 * @swagger
 * /orders/{orderId}:
 *   get:
 ...
 *         description: Order details retrieved successfully
 */
orderRoute.get('/:orderId', authMiddleware_1.authenticate, orderController_1.getOrderByIdHandler);
