...
const createOrderHandler = async (req, res) => {
    try {
        ...
        const { payment_method, shipping_address, shipping_method, currency } = req.body;
        if (!payment_method || !shipping_address || !shipping_method || !currency) {
        ...
        const newOrder = await (0, orderService_1.createOrder)(orderData);
        if (newOrder) {
