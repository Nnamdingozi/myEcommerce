...
//            <button className="absolute top-16 right-10 h-6 border-2 border-red-500 text-red-600 py-auto px-4 rounded-md hover:border-rose-100 focus:outline-none focus:ring-2 focus:ring-red-500"
//             onClick={handleClick}
//             >
//                 View orders
//                 </button>

//              {/* display order form when checkout is clicked */}
//             {isCheckout && (
//                 <div className='mb-6  fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50'>

//                    <div className='relative'>
//                    <OrderForm />
//                    <button className=" absolute top-12 right-3 text-red-800 hover:text-rose-400 "
...
//                                             </div>
//                                             <div className='flex items-center w-[20%] flex-col' >
//                                                 <p>Quantity: {itemQuantity}</p>
//                                                 <div className='flex justify-center items-center mt-3'>
//                                                     <button
//                                                         className='h-6 w-8 border-2 border-red-600 text-red-600 rounded-lg flex justify-center items-center'
//                                                         onClick={() => newQuantity(item.id!, itemQuantity + 1)}
//                                                     >
//                                                         +
//                                                     </button>
//                                                     <button
//                                                         className='h-6 w-8 border-2 border-red-600 text-red-600 rounded-lg flex justify-center items-center ml-8'
//                                                         onClick={() => {
//                                                             if (itemQuantity > 1) {
...
//                                             <button
//                                                 className='bg-red-600 text-white h-8 px-3  rounded-lg w-38'
            ...
            <div className='flex flex-col md:flex-row gap-6'>
                <div className='flex flex-col gap-4 md:w-3/4'>
                    {cart.map((item, index) => {
                        ...
                        return (
                            <div key={item.id} className='flex items-center border border-gray-300 rounded-lg p-4 shadow-lg bg-white h-64 mb-7'>
                                <Image
                                    src={`${baseUrl}${item.cartproduct.image_url}`}
                                    alt={item.cartproduct.name}
                                    height={200}
                                ...
                                <div className='flex flex-col ml-4 w-full'>
                                    ...
                                    <p className='text-lg font-semibold text-green-600 mt-1'>Price: ${Number(item.cartproduct.price).toFixed(2)}</p>
