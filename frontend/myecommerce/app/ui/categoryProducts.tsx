// import { Product, NewCart, ProductDetails } from '@/app/lib/definition';
...
//   setSuccessMessage: (string | null) => void;
//   successMessage:(string | null)
// }


// const CategoryProducts: React.FC<CategoryproductProps> = ({ categoryproducts, addToCart, getUserCart, setSuccessMessage, successMessate }) => {
//   const { token } = useUser();

//   console.log('categoryproducts value in props:', categoryproducts);


//   const handleAddToCart = (token: string, productId: number) => {
//     if (!token) {
...
//           </div>
//           <button className='bg-red-800 text-rose-100 w-[60%] mx-auto h-6 rounded-lg hover:bg-rose-100 hover:text-red-800' onClick={() => handleAddToCart(token!, categoryproduct.id)}>Add to Cart</button>
...
//   addToCart: (token: string, productId: number, quantity?: number) => Promise<NewCart | null | undefined>;
//   getUserCart: (token: string) => Promise<NewCart[] | undefined>;
//   setSuccessMessage: (message: string | null) => void; // Corrected type
//   successMessage: string | null; // Corrected type
// }
...
//       setSuccessMessage("Please register or log in to add items to your cart.");
//       setTimeout(() => {
//         setSuccessMessage(null); // Use null to clear the message
//       }, 3000);
//       return;
//     } else {
//       getUserCart(token!);
