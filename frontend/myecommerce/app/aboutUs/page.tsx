    ...
    <div className="flex flex-col md:flex-row items-center gap-8 px-6 py-12 md:py-20 max-w-7xl mx-auto">
      ...
      <div className="w-full md:w-2/3 shadow-md">
        ...
        <ul className="list-disc list-inside text-lg leading-relaxed mb-6">
          <li><strong>Wide Product Range:</strong> A thoughtfully curated collection of products to suit all tastes and preferences.</li>
          <li><strong>Secure Shopping:</strong> Robust measures to protect your data and transactions.</li>
          <li><strong>Fast Delivery:</strong> Ensuring purchases reach your doorstep quickly and efficiently.</li>
          <li><strong>Outstanding Customer Support:</strong> A friendly team ready to assist with any queries.</li>
        </ul>
        ...
        <p className="text-lg leading-relaxed mt-4">
          Thank you for choosing <strong>Family Shop</strong>. Together, let’s redefine online shopping.
          For any inquiries, feel free to <Link href="/contacts" className="text-blue-600 hover:underline">Contact Us</Link>.
        </p>
      </div>
    </div>
  );
